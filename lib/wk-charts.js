...
angular.module('wk.chart').factory('behaviorTooltip', function($log, $document, $rootScope, $compile, $templateCache, wkChartTemplates) {
  ...
  behaviorTooltip = function() {
    var body, bodyRect, compileTemplate, createClosure, forwardToBrush, forwardToSelection, me, positionBox, positionInitial, tooltipEnter, tooltipLeave, tooltipMove, _active, _area, _areaSelection, _chart, _compiledTempl, _container, _data, _hide, _markerG, _markerLine, _markerScale, _path, _reEntered, _scales, _showMarkerLine, _templ, _templScope, _tooltipDispatch;
    _active = false;
    _path = '';
    _hide = false;
...
angular.module('wk.chart').factory('container', function($log, $window, wkChartMargins, scaleList, axisConfig, d3Animation, behavior) {
  ...
  container = function() {
    ...
    _genChartFrame = function() {
      ...
      return _chartArea.append('rect').style('visibility', 'hidden').attr('class', 'wk-chart-background').datum({
        name: 'background'
      });
    };
    me.drawChartFrame = function(data, notAnimated) {
      ...
      return angular.element(_chartArea.node()).on('$destroy', function() {
        ...
        _chart.behavior().overlay(void 0);
        _gridArea = void 0;
        _element = void 0;
