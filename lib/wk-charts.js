...
angular.module('wk.chart').factory('legend', function($log, $compile, $rootScope, $templateCache, wkChartTemplates) {
  ...
  legend = function() {
    var destroyme, me, _containerDiv, _data, _id, _layout, _legendClass, _legendDiv, _legendScope, _legendStyle, _options, _parsedTemplate, _position, _scale, _show, _showValues, _template, _templatePath, _title;
    ...
    me.draw = function(data, options) {
      ...
      if (me.show()) {
        ...
        _legendScope.legendClass = me.legendClass();
        if (!_legendDiv) {
...
angular.module('wk.chart').factory('scale', function($log, legend, formatDefaults, wkChartScales, wkChartLocale) {
  var scale;
  scale = function() {
    var calcDomain, generateTickValues, keys, layerMax, layerMin, layerTotal, me, parsedValue, _axis, _axisLabel, _axisLabelStyle, _axisOrient, _axisOrientOld, _calculatedDomain, _chart, _domain, _domainCalc, _domainMax, _domainMin, _exponent, _gridStyle, _id, _inputFormatFn, _inputFormatString, _isHorizontal, _isOrdinal, _isVertical, _kind, _layerExclude, _layerProp, _layout, _legend, _lowerProperty, _outputFormatFn, _outputFormatString, _parent, _property, _range, _rangeOuterPadding, _rangePadding, _resetOnNewData, _reverse, _rotateTickLabels, _scale, _scaleType, _showAxis, _showGrid, _showLabel, _tickFormat, _tickInterval, _tickLabelStyle, _tickValues, _ticks, _timeFormat, _upperProperty;
    _id = '';
      ...
      if (!_isOrdinal && me.tickInterval()) {
        if (me.domainMax() !== void 0 && me.domainMin() !== void 0) {
          if (_scaleType === 'time') {
            ...
            if (parts.length === 2 && d3.time.hasOwnProperty(parts[0].toLowerCase())) {
            ...
            tickValue = Math.floor(1 + me.domainMin() / me.tickInterval()) * me.tickInterval();
            tickValues = [];
            i = 0;
