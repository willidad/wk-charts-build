...
/**
  ...
  @example
 */
angular.module('wk.chart').directive('area', function($log, utils, tooltipUtils) {
  var lineCntr;
  lineCntr = 0;
  return {
    restrict: 'A',
    ...
    link: function(scope, element, attrs, controller) {
      ...
      draw = function(data, options, x, y, color) {
        ...
        enter.append('path').attr('class', 'wk-chart-area-path').style('stroke', function(d) {
          return d.color;
        }).style('fill', function(d) {
          return d.color;
        }).style('opacity', 0).style('pointer-events', 'none');
        layers.select('.wk-chart-area-path').attr('transform', "translate(" + offset + ")").attr('d', function(d) {
...
/**
  ...
  @usesDimension color [type=category20]
 */
angular.module('wk.chart').directive('areaStacked', function($log, utils, tooltipUtils) {
  var stackedAreaCntr;
  stackedAreaCntr = 0;
  return {
    restrict: 'A',
    ...
    link: function(scope, element, attrs, controller) {
      ...
      draw = function(data, options, x, y, color) {
        ...
        enter = layers.enter().append('path').attr('class', 'wk-chart-area-path').style('pointer-events', 'none').style('opacity', 0);
        if (layoutOld.length > 0) {
          enter.attr('d', function(d) {
            if (addedPred[d.key]) {
        ...
        layers.style('fill', function(d, i) {
          ...
          return color.scale()(d.key);
        }).attr('transform', "translate(" + offs + ")").transition().duration(options.duration).attr('d', function(d) {
          return area(d.layer);
        }).style('opacity', 1);
...
/**
  ...
  @usesDimension color [type=category20]
 */
angular.module('wk.chart').directive('areaStackedVertical', function($log, utils, tooltipUtils) {
  ...
  return {
    ...
    link: function(scope, element, attrs, controller) {
      ...
      ttMoveMarker = function(idx) {
        ...
        _circles.enter().append('g').attr('class', "wk-chart-marker-" + _id).call(tooltipUtils.createTooltipMarkers);
        _circles.selectAll('circle').attr('cx', function(d) {
      ...
      draw = function(data, options, x, y, color) {
        ...
        layers.style('fill', function(d, i) {
          ...
          return color.scale()(d.key);
        }).attr('transform', "rotate(90) scale(1,-1)").transition().duration(options.duration).attr('d', function(d) {
          return area(d.layer);
        }).style('opacity', 1);
        layers.exit().transition().duration(options.duration).attr('d', function(d) {
          var succ;
...
/**
  ...
  @usesDimension color [type=category20]
 */
angular.module('wk.chart').directive('areaVertical', function($log, utils, tooltipUtils) {
  var lineCntr;
  lineCntr = 0;
  return {
    restrict: 'A',
    ...
    link: function(scope, element, attrs, controller) {
      ...
      draw = function(data, options, x, y, color) {
        ...
        layers.enter().append('g').attr('class', "wk-chart-layer").append('path').attr('class', 'wk-chart-area-path').style('stroke', function(d) {
          return d.color;
        }).style('fill', function(d) {
          return d.color;
        }).style('opacity', 0).style('pointer-events', 'none');
        layers.select('.wk-chart-area-path').attr('transform', "translate(0," + (options.width + offset) + ")rotate(-90)").attr('d', function(d) {
          return areaOld(d.value);
        }).transition().duration(options.duration).attr('d', function(d) {
          return areaNew(d.value);
        }).style('opacity', 0.7).style('pointer-events', 'none');
 ...
 */
angular.module('wk.chart').directive('line', function($log, behavior, utils, tooltipUtils, timing) {
  var lineCntr;
  lineCntr = 0;
  return {
    restrict: 'A',
...
/**
  ...
  @usesDimension color [type=category20] the line coloring dimension
 */
angular.module('wk.chart').directive('lineVertical', function($log, utils, tooltipUtils) {
  var lineCntr;
  lineCntr = 0;
  return {
    restrict: 'A',
...
angular.module('wk.chart').service('tooltipUtils', function($log) {
  this.createTooltipMarkers = function(selection, idx) {
    var hasIdx;
    hasIdx = arguments.length === 2;
    selection.append('circle').attr('class', 'wk-chart-tt-marker').attr('r', 9).style('fill', function(d) {
      if (hasIdx) {
        return d[idx].color;
      } else {
        return d.color;
    ...
    return selection.append('circle').attr('class', 'wk-chart-tt-marker').attr('r', 4).style('fill', function(d) {
      if (hasIdx) {
        return d[idx].color;
      } else {
        return d.color;
...
angular.module('wk.chart').service('dimensionFactory', function($log, modelUtils, modelTypes) {
  var CreateObj, addProperty;
  addProperty = function(obj, store, name) {
...
angular.module('wk.chart').service('layoutFactory', function($log, dimensionFactory, modelTypes, modelUtils) {
  var CreateObj, addGetter, addProperty;
  addProperty = function(obj, store, name) {
    return Object.defineProperty(obj, name, {
      get: function() {
        return store[name].value;
  ...
  addGetter = function(obj, store, name) {
    return Object.defineProperty(obj, name, {
      get: function() {
        return store[name];
      }
...
angular.module('wk.chart').service('modelTypes', function($log, wkChartScales) {
  var areaStyle, assign, axis, base, brush, brushed, dim, geojson, getScaleTypes, labels, layout, legend, markers, outerPadding, padding, projection, property, propertyType, range, selection, tooltips, valuesLegend;
...
angular.module('wk.chart').service('modelUtils', function($log, $templateCache, modelTypes) {
  ...
  this.templateUrl = function(value) {
    return !_.isEmpty($templateCache.get(value));
  };
  this.listVerifier = function() {
    return function(value) {
      return __indexOf.call(this.values, value) >= 0;
    };
  };
  this.attributeGenerator = function(name, value) {
    if (value) {
      return "" + name + "=\"" + value + "\"";
    } else {
      return name;
  ...
  this.attributeListGenerator = function(model) {
    var name, val, value;
    val = '';
    for (name in model) {
      value = model[name];
