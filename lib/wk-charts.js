...
angular.module('wk.chart').directive('area', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _areaStyle, _id, _initialOpacity, _scaleList, _showMarkers, _showOpacity, _spline, _tooltip, area, brush, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData;
      host = controller.me;
      _tooltip = void 0;
      _scaleList = {};
      _showMarkers = false;
...
angular.module('wk.chart').directive('areaStacked', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _areaStyle, _id, _scaleList, _showMarkers, _showOpacity, _spline, _tooltip, area, brush, drawPath, host, layers, layoutData, markers, offs, offset, scaleY, setAnimationEnd, setAnimationStart, stack, stackLayout, ttHelper, xData;
      host = controller.me;
...
angular.module('wk.chart').directive('areaStackedVertical', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _areaStyle, _id, _scaleList, _showMarkers, _showOpacity, _spline, _tooltip, area, brush, drawPath, host, layers, layoutData, markers, offs, offset, setAnimationEnd, setAnimationStart, stack, stackLayout, ttHelper, xData;
      host = controller.me;
      stack = d3.layout.stack();
      offset = 'zero';
      layers = null;
...
angular.module('wk.chart').directive('areaVertical', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _areaStyle, _circles, _id, _initialOpacity, _scaleList, _showMarkers, _showOpacity, _spline, _tooltip, _ttHighlight, area, brush, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData;
      host = controller.me;
      _tooltip = void 0;
      _ttHighlight = void 0;
      _circles = void 0;
...
angular.module('wk.chart').directive('bars', function($log, utils, barConfig, dataLabelFactory, dataManagerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var _barStyle, _id, _scaleList, _selected, _tooltip, barOuterPaddingOld, barPaddingOld, bars, brush, config, dataLabels, drawPath, host, setAnimationEnd, setAnimationStart, ttHelper, xData;
      host = controller.me;
      _id = "bars" + (sBarCntr++);
      bars = null;
      barPaddingOld = 0;
...
angular.module('wk.chart').directive('barClustered', function($log, utils, barConfig, dataManagerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var _barStyle, _id, _scaleList, _selected, _tooltip, barHeight, barOuterPaddingOld, barPaddingOld, clusterY, config, drawBrush, drawPath, host, initial, layers, setAnimationEnd, setAnimationStart, stack, ttHelper, xData;
      host = controller.me;
...
angular.module('wk.chart').directive('barStacked', function($log, utils, barConfig, dataManagerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _barStyle, _id, _scaleList, _selected, _tooltip, brush, config, drawPath, host, layers, setAnimationEnd, setAnimationStart, stack, ttHelper, xData;
      host = controller.me;
...
angular.module('wk.chart').directive('boxPlot', function($log, utils, barConfig, dataManagerFactory, markerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var _boxStyle, _id, _scaleList, _selected, _showMarkers, _tooltip, brush, config, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData;
      host = controller.me;
...
angular.module('wk.chart').directive('bubble', function($log, utils) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _id, _scaleList, _selected, _tooltip, draw, layout, ttEnter;
      layout = controller.me;
      _tooltip = void 0;
      _scaleList = {};
...
angular.module('wk.chart').directive('column', function($log, utils, barConfig, dataManagerFactory, dataLabelFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var _columnStyle, _id, _scaleList, _selected, _tooltip, brush, columns, config, dataLabels, drawPath, host, setAnimationEnd, setAnimationStart, ttHelper, xData;
      host = controller.me;
      _id = "column" + (sBarCntr++);
      columns = null;
      _scaleList = {};
...
angular.module('wk.chart').directive('columnClustered', function($log, utils, barConfig, dataManagerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var _columnStyle, _id, _scaleList, _selected, _tooltip, barOuterPaddingOld, barPaddingOld, barWidth, clusterX, config, drawBrush, drawPath, host, initial, layers, setAnimationEnd, setAnimationStart, stack, ttHelper, xData;
      host = controller.me;
...
angular.module('wk.chart').directive('columnStacked', function($log, utils, barConfig, dataManagerFactory, markerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _columnStyle, _id, _scaleList, _selected, _tooltip, brush, config, drawPath, host, layers, setAnimationEnd, setAnimationStart, stack, ttHelper, xData;
      host = controller.me;
...
angular.module('wk.chart').directive('geoMap', function($log, utils) {
  ...
  return {
    ...
    link: function(scope, element, attrs, controller) {
      var _dataMapping, _geoJson, _height, _id, _idProp, _path, _projection, _rotate, _scale, _scaleList, _selected, _tooltip, _width, _zoom, draw, layout, pathSel, ttEnter;
      layout = controller.me;
      _tooltip = void 0;
      _selected = void 0;
      _scaleList = {};
...
angular.module('wk.chart').directive('columnHistogramOld', function($log, barConfig, utils, wkChartMargins) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var _id, _merge, _scaleList, _selected, _tooltip, brush, buckets, config, draw, host, initial, labels, ttEnter;
      host = controller.me;
 ...
 */
angular.module('wk.chart').directive('line', function($log, behavior, utils, dataManagerFactory, tooltipHelperFactory, markerFactory, timing) {
  var lineCntr;
  lineCntr = 0;
  return {
    restrict: 'A',
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _id, _lineStyle, _scaleList, _showMarkers, _spline, _tooltip, brush, drawPath, host, layoutData, line, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData;
      host = controller.me;
      _tooltip = void 0;
      _showMarkers = false;
      _spline = false;
...
angular.module('wk.chart').directive('lineVertical', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _id, _lineStyle, _scaleList, _showMarkers, _spline, _tooltip, brush, brushStartIdx, drawPath, host, layoutData, line, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData;
      host = controller.me;
      brushStartIdx = 0;
      _tooltip = void 0;
      _showMarkers = false;
...
angular.module('wk.chart').directive('pie', function($log, utils) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var _donat, _id, _labelStyle, _merge, _pieStyle, _scaleList, _selected, _showLabels, _tooltip, animationDuration, draw, highlightSelected, initialShow, inner, labels, layout, outer, pieBox, polyline, selectionHandler, selectionOffset, ttEnter;
      layout = controller.me;
      _id = "pie" + (pieCntr++);
      inner = void 0;
      outer = void 0;
...
angular.module('wk.chart').directive('rangeArea', function($log, utils, dataManagerFactory, markerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _areaStyle, _id, _initialOpacity, _scaleList, _showMarkers, _spline, _tooltip, area, brush, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData;
      host = controller.me;
      _tooltip = void 0;
      _scaleList = {};
      _showMarkers = false;
...
angular.module('wk.chart').directive('rangeBars', function($log, utils, barConfig, dataManagerFactory, markerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var _barStyle, _id, _scaleList, _selected, _showMarkers, _tooltip, brush, config, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData;
      host = controller.me;
...
angular.module('wk.chart').directive('rangeColumn', function($log, utils, barConfig, dataManagerFactory, markerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var _columnStyle, _id, _scaleList, _selected, _showMarkers, _tooltip, brush, config, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData;
      host = controller.me;
...
angular.module('wk.chart').directive('scatter', function($log, utils) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var _id, _scaleList, _selected, _tooltip, draw, initialOpacity, layout, ttEnter;
      layout = controller.me;
      _tooltip = void 0;
      _selected = void 0;
...
angular.module('wk.chart').directive('spider', function($log, utils) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var _data, _id, _scaleList, _tooltip, axis, draw, layout, ttEnter;
      layout = controller.me;
      _tooltip = void 0;
      _scaleList = {};
...
angular.module('wk.chart').factory('layout', function($log, scale, scaleList, timing) {
  ...
  layoutCntr = 0;
  layout = function() {
    var _chart, _container, _data, _dataLabelStyle, _id, _layoutLifeCycle, _scaleList, _showLabels, buildArgs, getDrawArea, me;
...
angular.module('wk.chart').factory('scale', function($log, legend, formatDefaults, wkChartScales, wkChartLocale, maxTicks) {
  var scale;
  scale = function() {
    var _axis, _axisLabel, _axisLabelStyle, _axisOrient, _axisOrientOld, _calculatedDomain, _chart, _domain, _domainCalc, _domainMax, _domainMin, _exponent, _gridStyle, _id, _inputFormatFn, _inputFormatString, _isHorizontal, _isOrdinal, _isParentScale, _isVertical, _kind, _layerExclude, _layerProp, _layout, _legend, _lowerProperty, _orientation, _outputFormatFn, _outputFormatString, _parent, _parentScale, _property, _range, _rangeOuterPadding, _rangePadding, _resetOnNewData, _reverse, _rotateTickLabels, _scale, _scaleType, _showAxis, _showGrid, _showLabel, _tickFormat, _tickInterval, _tickLabelStyle, _tickValues, _ticks, _timeFormat, _upperProperty, calcDomain, generateTickValues, keys, layerMax, layerMin, layerTotal, me, parsedValue, verifyAndLimitTimeInterval;
    _id = '';
    _orientation = void 0;
...
angular.module('wk.chart').provider('wkChartScales', function() {
  var _customColors, _customMapFn, category20Linear, category20Radial, categoryColors, categoryColorsHashed, customScale, hashed, ordinalIdentity;
