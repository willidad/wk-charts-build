  ...
  return {
    ...
    link: function(scope, element, attrs, controller) {
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        ...
        boxEnter.append('rect').attr('class', 'wk-chart-box-uq').classed('wk-chart-hidden', true).style('opacity', 0).style('fill', 'white').style('stroke', 'black').call(_tooltip.tooltip).call(_selected);
        boxEnter.append('rect').attr('class', 'wk-chart-box-lq').classed('wk-chart-hidden', true).style('opacity', 0).style('fill', 'white').style('stroke', 'black').call(_tooltip.tooltip).call(_selected);
