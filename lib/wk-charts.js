...
angular.module('wk.chart').directive('area', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var area, brush, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData, _areaStyle, _id, _initialOpacity, _scaleList, _showMarkers, _showOpacity, _spline, _tooltip;
      host = controller.me;
      _tooltip = void 0;
      _scaleList = {};
      _showMarkers = false;
...
angular.module('wk.chart').directive('areaStacked', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var area, brush, drawPath, host, layers, layoutData, markers, offs, offset, scaleY, setAnimationEnd, setAnimationStart, stack, stackLayout, ttHelper, xData, _areaStyle, _id, _scaleList, _showMarkers, _showOpacity, _spline, _tooltip;
      host = controller.me;
...
angular.module('wk.chart').directive('areaStackedVertical', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var area, brush, drawPath, host, layers, layoutData, markers, offs, offset, setAnimationEnd, setAnimationStart, stack, stackLayout, ttHelper, xData, _areaStyle, _id, _scaleList, _showMarkers, _showOpacity, _spline, _tooltip;
      host = controller.me;
      stack = d3.layout.stack();
      offset = 'zero';
      layers = null;
...
angular.module('wk.chart').directive('areaVertical', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var area, brush, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData, _areaStyle, _circles, _id, _initialOpacity, _scaleList, _showMarkers, _showOpacity, _spline, _tooltip, _ttHighlight;
      host = controller.me;
      _tooltip = void 0;
      _ttHighlight = void 0;
      _circles = void 0;
...
angular.module('wk.chart').directive('boxPlot', function($log, utils, barConfig, dataManagerFactory, markerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var brush, config, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData, _boxStyle, _id, _scaleList, _selected, _showMarkers, _tooltip;
      host = controller.me;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        var barPadding, barWidth, box, boxEnter, i, j, lWhisker, layerKeys, lq, lwConn, med, p, prop, r, ranges, setStyle, showMax, showMin, uWhisker, uq, uwConn, _i, _len;
      ...
      return attrs.$observe('boxStyle', function(val) {
        if (val) {
          return _boxStyle = scope.$eval(val);
        }
      });
    }
  };
...
angular.module('wk.chart').directive('column', function($log, utils, barConfig, dataManagerFactory, dataLabelFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    link: function(scope, element, attrs, controller) {
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        var barPadding, barWidth, enter, offset, rect, setStyle, _colorByKey;
        setStyle = function(d) {
          var cVal, elem, style;
          elem = d3.select(this);
...
angular.module('wk.chart').factory('tooltipHelperFactory', function($log) {
  ...
  ttHelpers = function() {
    ...
    me.enter = function(data) {
      var cVal, key, layerKeys, style, _i, _len, _results;
      ...
      for (_i = 0, _len = layerKeys.length; _i < _len; _i++) {
        ...
        _results.push(this.layers[key].color = style);
      }
      return _results;
    };
...
angular.module('wk.chart').service('modelTypes', function($log, wkChartScales) {
  var areaStacked, areaStackedVertical, assign, axis, base, brush, brushed, dim, donat, geojson, getScaleTypes, labels, layout, legend, mapFunction, markers, outerPadding, padding, projection, property, propertyType, range, right, selection, spline, tickRotation, tooltips, top, valuesLegend;
