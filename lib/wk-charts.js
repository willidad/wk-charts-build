...
angular.module('wk.chart').service('modelTypes', function($log, wkChartScales) {
  var areaStyle, assign, axis, base, brush, brushed, dim, getScaleTypes, labels, layout, legend, markers, outerPadding, padding, property, propertyType, range, selection, tooltips, valuesLegend;
