        ...
        return {
          ...
          values: series.map(function(d) {
            return {
              ...
              targetValue: layer.added ? _valueScale.layerValue(d.newData, layer.key) : _valueScale.layerValue(d.targetData, layer.key),
              data: d.data
            };
          })
        };
        ...
        return {
          ...
          values: series.map(function(d) {
            return {
              ...
              targetValue: layer.deleted ? _valueScale.layerValue(d.oldData, layer.key) : _valueScale.layerValue(d.targetData, layer.key),
              data: d.data
            };
          })
        };
  ...
  return {
    ...
    link: function(scope, element, attrs, controller) {
      ...
      drawBrush = function(axis, idxRange) {
        ...
        return layers.attr('transform', function(d) {
          var y;
          return "translate(0, " + ((y = axis.scale()(d.key)) >= 0 ? x : -1000) + ")";
        }).selectAll('.wk-chart-bar').attr('height', height).attr('x', function(d) {
    ...
    me.prepareScaleHierarchy = function() {
      ...
      for (id in _ref) {
        ...
        if (!_ownedScales.hasScale(s) && (ps = _ownedScales.getKind(s.kind(), s.orientation()))) {
          _results.push(s.parentScale(ps));
        } else {
