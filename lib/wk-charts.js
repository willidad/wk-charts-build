...
angular.module('wk.chart').directive('brush', function($log, selectionSharing, behavior) {
  ...
  return {
    ...
    link: function(scope, element, attrs, controllers) {
      var brush, chart, host, layout, scales, x, xScale, y, yScale, _brushAreaSelection, _brushGroup, _id, _isAreaBrush, _ref, _ref1, _ref2, _selectables;
...
angular.module('wk.chart').directive('brushed', function($log, selectionSharing, timing) {
  ...
  return {
    ...
    link: function(scope, element, attrs, controllers) {
      var axis, brusher, chart, layout, rangeX, rangeY, x, y, _brushGroup, _id, _ref, _ref1, _ref2, _ref3, _ref4;
...
angular.module('wk.chart').factory('behaviorBrush', function($log, $window, selectionSharing, timing) {
  ...
  behaviorBrush = function() {
    var bottom, brushEnd, brushMove, brushStart, clearSelection, getSelectedObjects, hideBrushElements, left, me, positionBrushElements, resizeExtent, right, setSelection, startBottom, startLeft, startRight, startTop, top, _active, _areaBox, _areaNode, _backgroundBox, _boundsDomain, _boundsIdx, _boundsValues, _brushEvents, _brushGroup, _brushX, _brushXY, _brushY, _chart, _chartArea, _container, _data, _evTargetData, _extent, _lastBottomVal, _lastLeftVal, _lastRightVal, _lastTopVal, _overlay, _selectables, _startPos, _tooltip, _x, _y;
    me = function() {};
    _active = false;
    _overlay = void 0;
    _extent = void 0;
    ...
    setSelection = function(left, right, top, bottom) {
      var newDomain, s, _bottom, _bottomVal, _left, _leftVal, _right, _rightVal, _top, _topVal;
      if (_brushX) {
        if (me.x().reverse()) {
          s = left;
          left = right;
...
angular.module('wk.chart').factory('behavior', function($log, $window, behaviorTooltip, behaviorBrush, behaviorSelect) {
  var behavior;
  behavior = function() {
    var chart, chartArea, container, _brush, _selection, _tooltip;
...
angular.module('wk.chart').factory('behaviorSelect', function($log) {
  ...
  selectId = 0;
  select = function() {
    var clicked, me, _active, _chartArea, _id, _layout, _selectionEvents;
    _id = "select" + (selectId++);
    _chartArea = void 0;
    _layout = void 0;
    _active = false;
...
angular.module('wk.chart').factory('behaviorTooltip', function($log, $document, $rootScope, $compile, $templateCache, wkChartTemplates) {
  ...
  behaviorTooltip = function() {
    var body, bodyRect, compileTemplate, createClosure, forwardToBrush, forwardToSelection, me, positionBox, positionInitial, tooltipEnter, tooltipLeave, tooltipMove, _active, _area, _areaNode, _chart, _compiledTempl, _container, _data, _hide, _markerG, _markerLine, _markerScale, _path, _reEntered, _scales, _showMarkerLine, _templ, _templScope, _tooltipDispatch;
    _active = false;
    _path = '';
    _hide = false;
    ...
    tooltipEnter = function() {
      var dataObj, keyValue, ttElem, value, _areaBox, _pos;
      if (!_active || _hide) {
        return;
      }
      _templScope.layers = {};
...
angular.module('wk.chart').factory('chart', function($log, scaleList, container, behavior, d3Animation) {
  ...
  chartCntr = 0;
  chart = function() {
    var debounced, lifecycleFull, me, _allScales, _animationDuration, _backgroundStyle, _behavior, _brush, _container, _data, _editMode, _id, _layouts, _lifeCycle, _ownedScales, _scope, _showTooltip, _subTitle, _subTitleStyle, _title, _titleStyle, _toolTipTemplate, _tooltipStyle;
    _id = "chart" + (chartCntr++);
    me = function() {};
    _layouts = [];
    _container = void 0;
    ...
    me.prepareScaleHierarchy = function() {
      var id, ps, s, _ref, _results;
      _ref = _allScales.getOwned();
      _results = [];
      for (id in _ref) {
        s = _ref[id];
        if (!_ownedScales.hasScale(s) && (ps = _ownedScales.getKind(s.kind(), s.orientation()))) {
          ...
          if (s.reverse()) {
            _results.push(ps.reverse(true));
          } else {
            if (ps.reverse()) {
              _results.push(s.reverse(true));
            } else {
...
angular.module('wk.chart').factory('container', function($log, $window, wkChartMargins, wkChartTemplates, $templateCache) {
  ...
  containerCnt = 0;
  container = function() {
    var drawAndPositionText, drawAxis, drawGrid, drawPadding, drawTitleArea, getAxisRect, me, measureText, tickLabelsAnchor, tickLabelsShift, _behavior, _chart, _chartArea, _chartAreaDiv, _container, _containerId, _data, _duration, _element, _elementSelection, _genChartFrame, _gridArea, _innerHeight, _innerWidth, _layouts, _legends, _margin, _overlay, _removeAxis, _removeLabel, _spacedContainer, _svg, _titleHeight;
    me = function() {};
    ...
    me.drawChartFrame = function(data, notAnimated) {
      var axis, axisRect, bounds, dataLabelHeight, dataLabelRect, dataLabelWidth, dataLabels, k, l, label, labelHeight, leftMargin, s, titleAreaHeight, topMargin, _frameHeight, _frameWidth, _height, _i, _len, _maxDim, _ref, _ref1, _ref2, _width;
      ...
      _ref = _chart.allScales().getOwned();
      for (k in _ref) {
        s = _ref[k];
        if (!s.parentScale()) {
          if (s.showAxis()) {
      ...
      _ref1 = _chart.allScales().getOwned();
      for (k in _ref1) {
        s = _ref1[k];
        if (!s.parentScale()) {
          if (s.kind() === 'x') {
      ...
      _ref2 = _chart.allScales().getOwned();
      for (k in _ref2) {
        s = _ref2[k];
        if (!s.parentScale()) {
...
angular.module('wk.chart').factory('legend', function($log, $compile, $rootScope, $templateCache, wkChartTemplates) {
  ...
  legend = function() {
    var me, _containerDiv, _data, _id, _layout, _legendDiv, _legendScope, _legendStyle, _options, _parsedTemplate, _position, _scale, _show, _showValues, _template, _templatePath, _title;
    ...
    me.draw = function(data, options) {
      var chartAreaRect, colorScale, containerRect, layers, p, s, _i, _len, _ref, _ref1;
      _data = data;
      _options = options;
...
angular.module('wk.chart').factory('scale', function($log, legend, formatDefaults, wkChartScales, wkChartLocale, maxTicks) {
  var scale;
  scale = function() {
    var calcDomain, generateTickValues, keys, layerMax, layerMin, layerTotal, me, parsedValue, verifyAndLimitTimeInterval, _axis, _axisLabel, _axisLabelStyle, _axisOrient, _axisOrientOld, _calculatedDomain, _chart, _domain, _domainCalc, _domainMax, _domainMin, _exponent, _gridStyle, _id, _inputFormatFn, _inputFormatString, _isHorizontal, _isOrdinal, _isParentScale, _isVertical, _kind, _layerExclude, _layerProp, _layout, _legend, _lowerProperty, _orientation, _outputFormatFn, _outputFormatString, _parent, _parentScale, _property, _range, _rangeOuterPadding, _rangePadding, _resetOnNewData, _reverse, _rotateTickLabels, _scale, _scaleType, _showAxis, _showGrid, _showLabel, _tickFormat, _tickInterval, _tickLabelStyle, _tickValues, _ticks, _timeFormat, _upperProperty;
    _id = '';
    _orientation = void 0;
    ...
    me.range = function(range) {
      ...
      if (arguments.length === 0) {
        ...
        _range = range;
        if (_isOrdinal && ((_ref = me.kind()) === 'x' || _ref === 'y')) {
    ...
    me.register = function() {
      ...
      me.chart().lifeCycle().on("prepareData." + (me.id()), function(data) {
        ...
        ----------------------------------------------------------------------------------------------------------------
         */
        var calcRule, exclude, id, p, s, _i, _len, _ref, _ref1, _ref2;
        _ref = me.chart().allScales().getOwned();
        for (id in _ref) {
          s = _ref[id];
          if (s.parentScale()) {
        ...
        exclude = d3.set();
        _ref1 = me.chart().allScales().getOwned();
        for (id in _ref1) {
          s = _ref1[id];
...
angular.module('wk.chart').provider('wkChartScales', function() {
  var category20Linear, category20Radial, categoryColors, categoryColorsHashed, customScale, hashed, ordinalIdentity, _customColors, _customMapFn;
...
angular.module('wk.chart').directive('area', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var area, brush, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData, _areaStyle, _id, _initialOpacity, _scaleList, _showMarkers, _spline, _tooltip;
      host = controller.me;
      _tooltip = void 0;
      _scaleList = {};
      _showMarkers = false;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        ...
        path = layers.select('.wk-chart-area-path').attr('transform', "translate(" + offset + ")").style(_areaStyle).style('stroke', function(d) {
          return color.scale()(d.layerKey);
        });
      ...
      host.lifeCycle().on("destroy." + _id, function() {
      ...
      return attrs.$observe('areaStyle', function(val) {
        if (val) {
          return _areaStyle = scope.$eval(val);
        }
      });
    }
  };
...
angular.module('wk.chart').directive('areaStacked', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var area, brush, drawPath, host, layers, layoutData, markers, offs, offset, scaleY, setAnimationEnd, setAnimationStart, stack, stackLayout, ttHelper, xData, _areaStyle, _id, _scaleList, _showMarkers, _spline, _tooltip;
      host = controller.me;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        ...
        pathLayers = layers.select('.wk-chart-area-path').style('fill', function(d, i) {
          ...
          return color.scale()(d.layerKey);
        }).style(_areaStyle).attr('transform', "translate(" + offs + ")");
...
angular.module('wk.chart').directive('areaStackedVertical', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var area, brush, drawPath, host, layers, layoutData, markers, offs, offset, setAnimationEnd, setAnimationStart, stack, stackLayout, ttHelper, xData, _areaStyle, _id, _scaleList, _showMarkers, _spline, _tooltip;
      host = controller.me;
      stack = d3.layout.stack();
      offset = 'zero';
      layers = null;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        ...
        pathLayers = layers.select('.wk-chart-area-path').style('fill', function(d, i) {
          ...
          return color.scale()(d.layerKey);
        }).style(_areaStyle).attr('transform', "translate(" + offs + ")rotate(-90)");
        updLayers = doAnimate ? pathLayers.transition().duration(options.duration) : pathLayers;
        updLayers.attr('d', function(d) {
          return area(d.values);
        }).style('opacity', 1);
...
angular.module('wk.chart').directive('areaVertical', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var area, brush, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData, _areaStyle, _circles, _id, _initialOpacity, _scaleList, _showMarkers, _spline, _tooltip, _ttHighlight;
      host = controller.me;
      _tooltip = void 0;
      _ttHighlight = void 0;
      _circles = void 0;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        ...
        path = layers.select('.wk-chart-area-path').attr('transform', "translate(0," + offset + ")rotate(-90)").style(_areaStyle).style('stroke', function(d) {
          return color.scale()(d.layerKey);
        }).style('fill', function(d) {
          return color.scale()(d.layerKey);
...
angular.module('wk.chart').directive('bars', function($log, utils, barConfig, dataLabelFactory, dataManagerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var barOuterPaddingOld, barPaddingOld, bars, brush, config, dataLabels, drawPath, host, setAnimationEnd, setAnimationStart, ttHelper, xData, _barStyle, _id, _scaleList, _selected, _tooltip;
      host = controller.me;
      _id = "bars" + (sBarCntr++);
      bars = null;
      barPaddingOld = 0;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        var barHeight, barOuterPadding, barPadding, enter, offset, rect, setStyle, _colorByKey;
        setStyle = function(d) {
          var elem, style;
          elem = d3.select(this);
        ...
        rect = bars.select('rect').each(setStyle);
      ...
      return attrs.$observe('barStyle', function(val) {
        if (val) {
          return _barStyle = scope.$eval(val);
        }
      });
    }
  };
...
angular.module('wk.chart').directive('barClustered', function($log, utils, barConfig, dataManagerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var barHeight, barOuterPaddingOld, barPaddingOld, clusterY, config, drawBrush, drawPath, host, initial, layers, setAnimationEnd, setAnimationStart, stack, ttHelper, xData, _barStyle, _id, _scaleList, _selected, _tooltip;
      host = controller.me;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        var barOuterPadding, bars, clusterHeight, clusterPadding, layerKeys, offset, stackLayout;
...
angular.module('wk.chart').directive('barStacked', function($log, utils, barConfig, dataManagerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var brush, config, drawPath, host, layers, setAnimationEnd, setAnimationStart, stack, ttHelper, xData, _barStyle, _id, _scaleList, _selected, _tooltip;
      host = controller.me;
...
/**
  ...
  @usesDimension color [type=category20]
 */
angular.module('wk.chart').directive('boxPlot', function($log, utils, barConfig, dataManagerFactory, markerFactory, tooltipHelperFactory) {
  var sBarCntr;
  sBarCntr = 0;
  return {
    restrict: 'A',
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var brush, config, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData, _columnStyle, _id, _scaleList, _selected, _showMarkers, _tooltip;
      host = controller.me;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        var barPadding, barWidth, box, boxEnter, i, j, lWhisker, lq, lwConn, p, prop, r, ranges, showMax, showMin, uWhisker, uq, uwConn, _i, _len;
        ...
        while (i < data[0].values.length) {
          ...
          for (j = _i = 0, _len = prop.length; _i < _len; j = ++_i) {
            p = prop[j];
        ...
        boxEnter = box.enter().append('g').attr('class', 'wk-chart-box').attr('transform', function(d) {
          return "translate(" + (x.scale()(d.targetKey) + offset(d)) + ")";
        }).classed('wk-chart-hidden', true).style('opacity', 0);
        boxEnter.append('rect').attr('class', 'wk-chart-box-uq wk-chart-selectable').classed('wk-chart-hidden', true).style('opacity', 0).style('fill', 'white').style('stroke', 'black').call(_tooltip.tooltip).call(_selected);
        boxEnter.append('rect').attr('class', 'wk-chart-box-lq  wk-chart-selectable').classed('wk-chart-hidden', true).style('opacity', 0).style('fill', 'white').style('stroke', 'black').call(_tooltip.tooltip).call(_selected);
        ...
        (doAnimate ? uq.transition().duration(options.duration) : uq).attr('y', function(d) {
          ...
          return Math.abs(y.scale()(d.uq) - y.scale()(d.med));
        }).attr('width', function(d) {
          if (d.added || d.deleted) {
            return 0;
          } else {
        ...
        (doAnimate ? lq.transition().duration(options.duration) : lq).attr('y', function(d) {
          return y.scale()(d.med);
        }).attr('height', function(d) {
          return Math.abs(y.scale()(d.med) - y.scale()(d.lq));
        }).attr('width', function(d) {
          if (d.added || d.deleted) {
            return 0;
          } else {
      ...
      return attrs.$observe('columnStyle', function(val) {
        if (val) {
          return _columnStyle = scope.$eval(val);
        }
      });
    }
  };
    ...
    link: function(scope, element, attrs, controller) {
      ...
      ttEnter = function(data) {
        ...
        for (sName in _scaleList) {
          ...
          _results.push(this.layers[scale.axisLabel()] = {
      ...
      return layout.lifeCycle().on("destroy." + _id, function() {
...
angular.module('wk.chart').directive('column', function($log, utils, barConfig, dataManagerFactory, dataLabelFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var brush, columns, config, dataLabels, drawPath, host, setAnimationEnd, setAnimationStart, ttHelper, xData, _columnStyle, _id, _scaleList, _selected, _tooltip;
      host = controller.me;
      _id = "column" + (sBarCntr++);
      columns = null;
      _scaleList = {};
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        var barPadding, barWidth, enter, offset, rect, _colorByKey;
        _colorByKey = !color.property() && color.isOrdinal();
        ttHelper.colorByKey(_colorByKey);
        if (!columns) {
        ...
        }).style('opacity', 1).style(_columnStyle);
...
/**
  ...
  @usesDimension color [type=category20]
 */
angular.module('wk.chart').directive('columnClustered', function($log, utils, barConfig, dataManagerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var barOuterPaddingOld, barPaddingOld, barWidth, clusterX, config, drawBrush, drawPath, host, initial, layers, setAnimationEnd, setAnimationStart, stack, ttHelper, xData, _columnStyle, _id, _scaleList, _selected, _tooltip;
      host = controller.me;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        var barOuterPadding, bars, clusterPadding, clusterWidth, layerKeys, offset, stackLayout;
        layerKeys = data.filter(function(d) {
          return !d.added && !d.deleted;
        }).map(function(d) {
          return d.layerKey;
...
angular.module('wk.chart').directive('columnStacked', function($log, utils, barConfig, dataManagerFactory, markerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var brush, config, drawPath, host, layers, setAnimationEnd, setAnimationStart, stack, ttHelper, xData, _columnStyle, _id, _scaleList, _selected, _tooltip;
      host = controller.me;
...
/**
  ...
  @usesDimension color [type=category20]
 */
angular.module('wk.chart').directive('columnHistogramOld', function($log, barConfig, utils, wkChartMargins) {
  var sHistoCntr;
  sHistoCntr = 0;
  return {
    restrict: 'A',
...
angular.module('wk.chart').directive('line', function($log, behavior, utils, dataManagerFactory, tooltipHelperFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var brush, drawPath, host, layoutData, line, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData, _id, _lineStyle, _scaleList, _showMarkers, _spline, _tooltip;
      host = controller.me;
      _tooltip = void 0;
      _showMarkers = false;
      _spline = false;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        ...
        if (doAnimate) {
          layers.select('.wk-chart-line').attr('transform', "translate(" + offset + ")").style(_lineStyle).transition().duration(options.duration).call(drawLines);
        } else {
          layers.select('.wk-chart-line').attr('transform', "translate(" + offset + ")").style(_lineStyle).call(drawLines);
        }
        layers.exit().remove();
      ...
      return attrs.$observe('lineStyle', function(val) {
        if (val) {
          return _lineStyle = scope.$eval(val);
        }
      });
    }
  };
...
angular.module('wk.chart').directive('lineVertical', function($log, utils, tooltipHelperFactory, dataManagerFactory, markerFactory) {
  ...
  return {
    ...
    require: 'layout',
    link: function(scope, element, attrs, controller) {
      var brush, brushStartIdx, drawPath, host, layoutData, line, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData, _id, _lineStyle, _scaleList, _showMarkers, _spline, _tooltip;
      host = controller.me;
      brushStartIdx = 0;
      _tooltip = void 0;
      _showMarkers = false;
      ...
      drawPath = function(doAnimate, data, options, x, y, color) {
        ...
        if (doAnimate) {
          layers.select('.wk-chart-line').attr('transform', "translate(0," + offset + ")").style(_lineStyle).transition().duration(options.duration).call(drawLines);
        } else {
          layers.select('.wk-chart-line').attr('transform', "translate(0," + offset + ")").style(_lineStyle).call(drawLines);
        }
        layers.exit().remove();
        markers.isVertical(true).x(function(d) {
          return x.scale()(d.layerAdded || d.layerDeleted ? 0 : d.value);
...
angular.module('wk.chart').directive('pie', function($log, utils) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var animationDuration, draw, highlightSelected, initialShow, inner, labels, layout, outer, pieBox, polyline, selectionHandler, selectionOffset, ttEnter, _donat, _id, _labelStyle, _merge, _pieStyle, _scaleList, _selected, _showLabels, _tooltip;
      layout = controller.me;
      _id = "pie" + (pieCntr++);
      inner = void 0;
      outer = void 0;
      ...
      ttEnter = function(data) {
        ...
        return this.layers[_scaleList.color.formattedValue(data)] = {
      ...
      draw = function(data, options, x, y, color, size) {
        ...
        inner.transition().duration(options.duration).style('opacity', 1).style(_pieStyle).attrTween('d', arcTween);
      ...
      return attrs.$observe('pieStyle', function(val) {
        if (val) {
          return _pieStyle = scope.$eval(val);
        }
      });
    }
  };
    ...
    link: function(scope, element, attrs, controller) {
      ...
      drawPath = function(doAnimate, data, options, x, y, color, size, shape, rangeX, rangeY) {
        ...
        range.style('stroke', function(d) {
          return color.scale()(d.layerKey);
        }).style('pointer-events', 'none').style(_areaStyle);
...
angular.module('wk.chart').directive('rangeBars', function($log, utils, barConfig, dataManagerFactory, markerFactory, tooltipHelperFactory) {
  ...
  return {
    ...
    require: '^layout',
    link: function(scope, element, attrs, controller) {
      var brush, config, drawPath, host, layoutData, markers, offset, setAnimationEnd, setAnimationStart, ttHelper, xData, _barStyle, _id, _scaleList, _selected, _showMarkers, _tooltip;
      host = controller.me;
    ...
    link: function(scope, element, attrs, controller) {
      ...
      ttEnter = function(data) {
        ...
        for (_i = 0, _len = _data.length; _i < _len; _i++) {
          d = _data[_i];
          _results.push(this.layers[_scaleList.x.value(d)] = {
...
angular.module('wk.chart').factory('markerFactory', function($log, d3Animation) {
  ...
  return markers = function() {
    var me, _active, _color, _duration, _id, _initialOpacity, _isVertical, _keyScale, _markerSelection, _opacity, _x, _y;
    _x = void 0;
    _y = void 0;
    _color = void 0;
    _active = false;
...
angular.module('wk.chart').factory('tooltipHelperFactory', function($log) {
  ...
  ttHelpers = function() {
    ...
    me.enter = function(data) {
      var key, layerKeys, _i, _len, _results;
  ...
  CreateObj = function(model) {
    return (function(model) {
      ...
      me.removeProperty = function(property, dimName, layoutName) {
        var del, l, layoutDim, prop, props, toDelete, _i, _len;
        l = _data.layouts[layoutName];
        layoutDim = l.dimensions[dimName];
        prop = layoutDim.property;
        props = prop.split(',');
...
angular.module('wk.chart').service('modelTypes', function($log, wkChartScales) {
  var areaStacked, areaStackedVertical, assign, axis, base, brush, brushed, dim, donat, geojson, getScaleTypes, labels, layout, legend, markers, outerPadding, padding, projection, property, propertyType, range, right, selection, spline, tickRotation, tooltips, top, valuesLegend;
